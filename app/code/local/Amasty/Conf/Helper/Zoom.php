...
class Amasty_Conf_Helper_Zoom extends Mage_Core_Helper_Abstract
{
   public function jsParam()
   {
       ...
       $param['zoom']['labelDisplay'] = (bool) Mage::getStoreConfig('amconf/image_label/display');
       if ($param['zoom']['labelDisplay']) {
           $param['zoom']['labelBottom'] = (bool) Mage::getStoreConfig('amconf/image_label/position');
           $param['zoom']['labelOpacity'] = Mage::getStoreConfig('amconf/image_label/opacity') / 10;
           $param['zoom']['labelTextColor'] = '#' . Mage::getStoreConfig('amconf/image_label/text_color');
           $param['zoom']['labelBackgroundColor'] = '#' . Mage::getStoreConfig('amconf/image_label/background_color');
       }

       // save lens settings for mobile
       $param['zoom']['mobile']["lensShape"] = "round";
       $param['zoom']['mobile']["lensSize"] = Mage::getStoreConfig('amconf/zoom_settings/lens_size');
       $param['zoom']['mobile']["borderSize"] = 1;
       ...
       /*Lightbox configuration start*/  
        if(Mage::getStoreConfig('amconf/lightbox/enable')) {
            ...
            $param['lightbox']['transitionEffect'] = Mage::getStoreConfig('amconf/lightbox/effect');
            ...
            $param['lightbox']['thumbs']['autoStart'] = (bool)Mage::getStoreConfig('amconf/lightbox/thumbnail_helper');
            if (Mage::getStoreConfig('amconf/lightbox/thumbnail_helper')) {
                $param['lightbox']['helpers']['thumbs'] = array(
                    "width" => 50,
                    "height" => 50
                );
            }
	   ...
	   //$param['carousel']['items'] = array("width" => "600", "visible" => array("min" => "1", "max" => "2"));
