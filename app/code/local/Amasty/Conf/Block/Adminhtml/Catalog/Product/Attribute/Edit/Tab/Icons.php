 ...
 * @package Amasty_Conf
 */
class Amasty_Conf_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Icons extends Mage_Core_Block_Template
{
    private $_confAttr;
    ...
    public function __construct()
    {
        ...
        $this->setChild('amconf_image',  Mage::app()->getLayout()->createBlock('amconf/adminhtml_catalog_product_attribute_edit_tab_images'));

        $this->getOptionsCollection()->setPageSize(Mage::helper('amconf')->getLimit());
        $this->getOptionsCollection()->setCurPage(1);
    }
